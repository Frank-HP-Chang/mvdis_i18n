...
> | `GRAB_DMV_NO` | 監理站代碼 | `41`（板橋） |
> | `GRAB_EXAM_DATE` | 指定考試日期（西元）；**留空＝掃描模式搶最近可報名** | （留空） |
> | `GRAB_SCAN_DAYS` | 掃描模式往後掃幾天（可省略，預設 60） | `60` |
> | `GRAB_OPEN_TIME` | 開始搶的精確時刻；現在就搶可留空 | `2026-06-25T00:00:00+08:00` |
